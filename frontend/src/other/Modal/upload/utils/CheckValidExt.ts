...
// this function is here although we tell browser to accept only certain extensions as not all browsers have the capability
export const CheckValidExt = (
    ...
    // chceck if the extension is valid
