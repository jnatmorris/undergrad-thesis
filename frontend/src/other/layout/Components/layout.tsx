    ...
    return (
        <>
            ...
            <Head>
                ...
                <meta
                    name="description"
                    content="This page apart of an undergrad thesis titled aimed at making a SAAS service generation of training data in trajectory-based molecular machine learning."
                />
